            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <select id="servicecategory1" class="form-control" size="10" style="word-wrap:break-word;width:100%;">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <select id="servicecategory3" class="form-control" size="10">
				...
				<div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <select id="servicecategory4" class="form-control" size="10">
                        </select>
                    </div>
                </div>
				<div class="col-sm-3">
